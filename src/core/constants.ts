...
export const ARTIFACT_FILES = {
  ...
  docsStartHere: "docs/START_HERE.md",
  docsIndex: "docs/INDEX.md",
  coreConcepts: "docs/CORE_CONCEPTS.md",
  highlights: "docs/HIGHLIGHTS.md",
  architecture: "docs/SYSTEM_ARCHITECTURE.md",
  learningPath: "docs/LEARNING_PATH.md",
  learningPathBeginner: "docs/LEARNING_PATH_BEGINNER.md",
  learningPathAdvanced: "docs/LEARNING_PATH_ADVANCED.md",
